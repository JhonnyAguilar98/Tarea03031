 ...
 */
package Tarea03031.vista;

import javax.swing.table.DefaultTableModel;
import javax.swing.table.TableModel;
import Tarea03031.controlador.PersonajeControl;
/**
 *
 * @author HP OME
 */
public class PersonajeVentana extends javax.swing.JFrame {
    ...
    private void actualizarTabla()
    {
        ...
        encabezado[0]="Nombre";
        encabezado[1]="Escenas";
        encabezado[2]="Edad";
        
        var datos = new Object[this.personajeControl.listar().size()][3];
        ...
        for(var personaje:this.personajeControl.listar())
        {
            ...
            datos[i][2]=personaje.getEdadDelPersonaje();
            i++;
        }
